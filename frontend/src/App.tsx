...
import { DepositFilterListPage } from './pages/DepositFilterListPage';
import { DepositFilterEditPage } from './pages/DepositFilterEditPage';
  ...
  return (
    <Routes>
      ...
      <Route element={<AppShell />}>
        ...
        <Route path="/deposit-filters" element={<DepositFilterListPage />} />
        <Route path="/deposit-filters/new" element={<DepositFilterEditPage />} />
        <Route path="/deposit-filters/:id/edit" element={<DepositFilterEditPage />} />
